...
import '../../feature/exam/api/datasource_impl/exam_remote_datasource_impl.dart'
    as _i920;
import '../../feature/exam/data/datasource/exam_local_datasource.dart' as _i753;
...
import '../../feature/exam/domain/useCases/check_question_use_case.dart'
    as _i408;
import '../../feature/exam/domain/useCases/get_completed_exams_usecase.dart'
    as _i751;
...
import '../../feature/exam/presentation/view_model/result_history_cubit/result_history_cubit.dart'
    as _i254;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i753.ExamLocalDataSource>(
        () => _i753.ExamLocalDataSource());
    gh.factory<_i585.ForgetPasswordApiClient>(
        () => _i585.ForgetPasswordApiClient(gh<_i361.Dio>()));
    gh.factory<_i1033.LoginApiClient>(
        () => _i1033.LoginApiClient(gh<_i361.Dio>()));
    gh.factory<_i48.SignupApiClient>(
        () => _i48.SignupApiClient(gh<_i361.Dio>()));
    gh.factory<_i716.ExamApiClient>(() => _i716.ExamApiClient(gh<_i361.Dio>()));
    gh.factory<_i45.SubjectsApiClient>(
        () => _i45.SubjectsApiClient(gh<_i361.Dio>()));
    gh.factory<_i553.ProfileApiClient>(
        () => _i553.ProfileApiClient(gh<_i361.Dio>()));
    gh.factory<_i1015.SubjectExamApiClient>(
        () => _i1015.SubjectExamApiClient(gh<_i361.Dio>()));
    ...
    gh.factory<_i903.ExamRepo>(() => _i304.ExamRepoImpl(
          gh<_i936.ExamRemoteDataSource>(),
          gh<_i753.ExamLocalDataSource>(),
        ));
    ...
    gh.factory<_i751.GetCompletedExamsUseCase>(
        () => _i751.GetCompletedExamsUseCase(gh<_i903.ExamRepo>()));
    ...
    gh.singleton<_i721.ProfileCubit>(() => _i721.ProfileCubit(
    ...
    gh.factory<_i609.ForgetPasswordCubit>(() => _i609.ForgetPasswordCubit(
    ...
    gh.factory<_i254.ResultHistoryCubit>(
        () => _i254.ResultHistoryCubit(gh<_i751.GetCompletedExamsUseCase>()));
    gh.factory<_i497.ExamCubit>(
        () => _i497.ExamCubit(gh<_i495.GetQuestionUseCase>()));
    gh.factory<_i53.SignupRepo>(() => _i578.SignupRepoImpl(
    ...
    gh.factory<_i399.ExploreCubit>(() => _i399.ExploreCubit(
