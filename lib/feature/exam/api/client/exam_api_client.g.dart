...
class _ExamApiClient implements ExamApiClient {
  ...
  @override
  Future<QuestionResponse> getQuestion(String examId) async {
  ...
  Future<CheckQuestionResponse> checkQuestion(
      CheckQuestionRequest checkQuestionRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(checkQuestionRequest.toJson());
    final _options = _setStreamType<CheckQuestionResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CheckQuestionResponse _value;
    try {
      _value = CheckQuestionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
